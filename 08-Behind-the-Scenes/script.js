...
/*
  ...
  Lexical scoping - Scoping controlled by placement of functions and blocks in the code.(linear reading of the code from top to bottom and child to parent)
...
/*
 ...
 Block Scope (ES6) - Variables are only accessible inside a block. HOWEVER, only applies to 'let' and 'const'. NOTE: In strict mode; functions become block scoped!
*/
